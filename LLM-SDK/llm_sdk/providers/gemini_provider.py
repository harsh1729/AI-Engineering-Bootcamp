...
from llm_sdk.config import GEMINI_API_KEY, GEMINI_FALLBACK_MODEL, GEMINI_MODEL
...
from llm_sdk.serializers import GeminiRequestSerializer, GeminiResponseSerializer, GeminiResponseChunkSerializer
...
class GeminiProvider(LLMProvider):
    ...
    def _get_retry_targets(self, request: LLMRequest) -> list[str | None]:
        ...
        # An explicit per-request model is authoritative: retry the same
        # model rather than silently swapping to the configured fallback.
        if request.model:
